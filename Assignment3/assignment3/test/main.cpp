...
int main(int argc, char *argv[])
{
	...
	//	Material(SPEC, Vector3d(0, 0, 1)))));
	//scene.add( dynamic_cast<Object*>(new Mesh(Vector3d(250,100,40), "objFile/dragon2.obj", Material(SPEC, Vector3d(0.0, 0.0, 1.0)))) );
	scene.add(dynamic_cast<Object*>(new Mesh(Vector3d(230, 150, 300), "objFile/patrick.obj", Material(SPEC, Vector3d(1, 1, 0)))));
	//--------------------------------------------------------------------------
